...
class ScreenRecorder {
    ...
    async start() {
        ...
        this._process = await new node_simctl_1.default().exec('io', {
            args,
            asynchronous: true,
        });
...
async function extractSimulatorUdid(caps) {
    ...
    const allDevices = lodash_1.default.flatMap(lodash_1.default.values(await new node_simctl_1.default().getDevices(null, 'iOS')));

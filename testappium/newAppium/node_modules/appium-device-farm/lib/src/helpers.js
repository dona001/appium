...
exports.isAppiumRunningAt = exports.isDeviceFarmRunning = exports.stripAppiumPrefixes = exports.isCloud = exports.hasHubArgument = exports.isPortBusy = exports.nodeUrl = exports.getFreePort = exports.checkIfPathIsAbsolute = exports.isWindows = exports.cachePath = exports.isMac = exports.spinWith = exports.asyncForEach = void 0;
...
function isDeviceFarmRunning(host) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            logger_1.default.info(`Device Farm is not running at ${host}. Error: ${error}`);
            return false;
        }
    });
}
exports.isDeviceFarmRunning = isDeviceFarmRunning;
function isAppiumRunningAt(url) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const timeoutMs = 30000;
            const result = yield (0, axios_1.default)({

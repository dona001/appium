...
describe('Android Test', () => {
    const deviceManager = new device_managers_1.DeviceFarmManager('android', { androidDeviceType: 'both', iosDeviceType: 'both' }, 4723, Object.assign(pluginArgs, {}));
    ...
    it('Allocate free device and verify the device state is busy in db', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const allDeviceIds = (yield db_1.ADTDatabase.DeviceModel)
            .chain()
            .find({ udid: devices.udid })
            .data();
        (0, chai_1.expect)(allDeviceIds[0].busy).to.be.true;
    }));
    it('Allocate second free device and verify both the device state is busy in db', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, device_utils_1.initializeStorage)();
        const deviceManager = new device_managers_1.DeviceFarmManager('android', { androidDeviceType: 'both', iosDeviceType: 'both' }, 4723, Object.assign({}, IPluginArgs_1.DefaultPluginArgs, pluginArgs));
        typedi_1.Container.set(device_managers_1.DeviceFarmManager, deviceManager);
        ...
        const allDeviceIds = (yield db_1.ADTDatabase.DeviceModel).chain().find().data();
    ...
    it('Finding a device should throw error when all devices are busy', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, device_utils_1.initializeStorage)();
        const deviceManager = new device_managers_1.DeviceFarmManager('android', { androidDeviceType: 'both', iosDeviceType: 'both' }, 4723, pluginArgs);
        typedi_1.Container.set(device_managers_1.DeviceFarmManager, deviceManager);
        const hub = pluginArgs.hub;
        yield (0, device_utils_1.updateDeviceList)(pluginArgs.bindHostOrIp, hub);
        const capabilities = {
        ...
        yield (0, device_utils_1.allocateDeviceForSession)(capabilities, 1000, 1000, pluginArgs).catch((error) => (0, chai_1.expect)(error)
            .to.be.an('error')
            .with.property('message', 'No device found for filters: {"platform":"android","busy":false,"userBlocked":false}'));
    }));
});

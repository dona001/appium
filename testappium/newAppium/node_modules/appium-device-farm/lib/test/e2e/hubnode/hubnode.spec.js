...
describe('E2E Hub and Node', () => {
    ...
    it('should have devices on the hub', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const res = yield axios_1.default.get(`http://${APPIUM_HOST}:${e2ehelper_1.HUB_APPIUM_PORT}/device-farm/api/devices`);
    ...
    it('Clean pending session when session failed to start', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const res = yield axios_1.default.get(`http://${APPIUM_HOST}:${e2ehelper_1.HUB_APPIUM_PORT}/device-farm/api/queues/length`);
        (0, chai_1.expect)(res.status).to.equal(200);

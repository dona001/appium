...
describe('E2E Forward Request', () => {
    ...
    it('can forward session request to node', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // all devices
        const allDevices = (yield axios_1.default.get(`http://${e2ehelper_2.hub_config.bindHostOrIp}:${e2ehelper_1.HUB_APPIUM_PORT}/device-farm/api/devices`)).data;
        ...
        const newAllDevices = (yield axios_1.default.get(`http://${e2ehelper_2.hub_config.bindHostOrIp}:${e2ehelper_1.HUB_APPIUM_PORT}/device-farm/api/devices`)).data;

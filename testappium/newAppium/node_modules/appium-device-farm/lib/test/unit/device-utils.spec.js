...
describe('Device Utils', () => {
    ...
    it('Allocating device should set device to be busy', function () {
        return __awaiter(this, void 0, void 0, function* () {
            (yield db_1.ADTDatabase.DeviceModel).removeDataOnly();
            const deviceManager = new device_managers_1.DeviceFarmManager('android', { androidDeviceType: 'both', iosDeviceType: 'both' }, 4723, Object.assign(pluginArgs, { maxSessions: 3 }));
            ...
            let allocatedDeviceForFirstSession = yield DeviceUtils.allocateDeviceForSession(capabilities, 1000, 1000, pluginArgs);
            function getFilteredDevice(udid, host) {
                return __awaiter(this, void 0, void 0, function* () {
                    return (yield db_1.ADTDatabase.DeviceModel).chain().find({ udid, host }).data();
                });
            }
            let foundDevice = (yield getFilteredDevice(allocatedDeviceForFirstSession.udid, allocatedDeviceForFirstSession.host))[0];
            expect(foundDevice.busy).to.be.true;
            let filterDeviceWithSameUDID = (yield db_1.ADTDatabase.DeviceModel)
                .chain()
            ...
            filterDeviceWithSameUDID.filter((device) => !device.busy).length.should.be.equal(1);
            let allocatedDeviceForSecondSession = yield DeviceUtils.allocateDeviceForSession(capabilities, 1000, 1000, pluginArgs);
            ...
            let foundSecondDevice = (yield db_1.ADTDatabase.DeviceModel)
                .chain()
                .find({
            ...
            filterDeviceWithSameUDID = (yield db_1.ADTDatabase.DeviceModel)
                .chain()
                .find({ udid: allocatedDeviceForFirstSession.udid })
                .data();
            ...
            yield (0, device_utils_1.allocateDeviceForSession)(capabilities, 1000, 1000, pluginArgs).catch((error) => expect(error)
                .to.be.an('error')
                .with.property('message', 'No device found for filters: {"platform":"android","udid":"emulator-5555","busy":false,"userBlocked":false}'));
        });
    });
    ...
    it('Block and unblock device', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((yield db_1.ADTDatabase.DeviceModel)
            .chain()
        ...
        const device = (yield db_1.ADTDatabase.DeviceModel)
            .chain()
            .find({ udid: targetDevice.udid, host: targetDevice.host })
            .data()[0];
    ...
    it('should remove stale devices', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((yield db_1.ADTDatabase.DeviceModel).chain().find({ udid: 'emulator-9999' }).data().length).to.be.equal(0);
    }));
});
